...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
	...
	G4double pSTheta = 89.5 * deg; //165 for 15 degree cap
	G4double pDTheta = 1 * deg; // for 15 degree cap;
	...
	physi_S1 = new G4PVPlacement(sourceRot, G4ThreeVector(S1_x, S1_y, S1_z), logic_S1, "source", logic_w, false, 0);
