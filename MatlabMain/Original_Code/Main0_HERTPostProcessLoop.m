...
close all;
clc;
addpath 'E:\HERT\Matlab Main Share\'
%% Reads in all files names

cd 'E:\HERT\Matlab Main Share\Result\'; %Changes address to where results are stored
%read files from ./Result folder stores into 1*C array
%inputfolder = 'E:\HERT\Matlab Main Share\Result';
outputfolder = 'E:\HERT\Matlab Main Share\Result\PostProcess';%location for where post process files should be saved
